...
export function StatusDot({ active, identityActive, className = '', variant = 'inline' }: StatusDotProps) {
  ...
  const color = !active
    ...
    : globallyOff
      ...
      : 'bg-green-500';
  const title = !active
    ? 'Inactive - no access to this app'
    : globallyOff
      ? 'Deactivated across all Premium apps - cannot sign in'
      : 'Active';
